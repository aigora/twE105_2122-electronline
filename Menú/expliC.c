...
printf("Presione A para avanzar hacia la izquierda.\n");
printf("Presione S para avanzar hacia abajo.\n");
printf("Presione D para avanzar hacia la derecha.\n");
}
...
printf("variedad de laberintos. Además, se incluye la posibilidad de cambiar de avatar y de incluir música.\n");
