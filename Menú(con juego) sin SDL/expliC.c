...
void controles(void){
printf("\n");
printf("Presione 'flecha arriba' para avanzar hacia arriba.\n");
printf("Presione 'flecha izquierda' para avanzar hacia la izquierda.\n");
printf("Presione 'flecha abajo' para avanzar hacia abajo.\n");
printf("Presione 'flecha derecha' para avanzar hacia la derecha.\n");
printf("Debajo del laberinto aparecerán las coordenadas de su posición en cada movimiento.\n");
